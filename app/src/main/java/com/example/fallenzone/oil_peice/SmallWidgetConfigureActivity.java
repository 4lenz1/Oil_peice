package com.example.fallenzone.oil_peice;
...
public class SmallWidgetConfigureActivity extends Activity {
    ...
    public SmallWidgetConfigureActivity() {
        super();
    }
    ...
    public void onCreate(Bundle icicle) {
       ...
       // mAppWidgetText = (EditText) findViewById(R.id.appwidget_text);
        ...
        Spinner oil_type_spinner = (Spinner) findViewById(R.id.oil_type_spinner);

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.oil_type_list,android.R.layout.simple_spinner_item );
       ...
       // mAppWidgetText.setText(loadTitlePref(SmallWidgetConfigureActivity.this, mAppWidgetId));
    }

    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = SmallWidgetConfigureActivity.this;
